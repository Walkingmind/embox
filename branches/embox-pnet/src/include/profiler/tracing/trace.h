...
extern struct __trace_block *trace_block_get_by_name(const char *name);
extern void trace_point_set_condition(struct __trace_point *tp,
		void *cond, bool (*hnd)(void *cond));
