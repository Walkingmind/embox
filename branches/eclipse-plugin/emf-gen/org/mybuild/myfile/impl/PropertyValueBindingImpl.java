 ...
 * @generated
 */
public class PropertyValueBindingImpl extends EObjectImpl implements PropertyValueBinding
{
	/**
	...
	public void setProperty(Property newProperty)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyFilePackage.PROPERTY_VALUE_BINDING__PROPERTY, oldProperty, property));
	}
	...
	public void setValue(Value newValue)
	{
		if (newValue != value) {
			...
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyFilePackage.PROPERTY_VALUE_BINDING__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MyFilePackage.PROPERTY_VALUE_BINDING__VALUE, newValue, newValue));
	}
