...
$(call start_test,list_fold1)
$(call test_assert,$(call list_fold1,plus,1 2 3 4),10)
$(call test_assert,$(call list_fold1,divide,64 4 2 8),1)
$(call test_assert,$(call list_fold1,divide,42,),42)
$(call test_assert,$(call list_fold1,max,1 2 3 4 5 6 7),7)
$(call test_assert,$(call list_fold1,max,3 6 12 4 55 11),55)
$(call stop_test)
