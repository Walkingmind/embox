...
int flash_if_read_id(uint32_t address, uint32_t *mcode, uint32_t *device_id) __ATTR;
/*
int flash_if_write(FLASH_DEV *flash_dev, uint32_t addr, void *buff, uint32_t size) __ATTR;
*/
...
int flash_if_get_block_size(FLASH_DEV *flash_dev, uint32_t blocknum) __ATTR;
...
int flash_if_get_start_block(FLASH_DEV *flash_dev, uint32_t addr) __ATTR;
