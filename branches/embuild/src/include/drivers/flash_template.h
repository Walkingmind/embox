 ...
 * device.
 */
extern void flash_clear_status(FLASH_DEV *flash_dev);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_erase_all_blocks(FLASH_DEV *flash_dev);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_erase_block(FLASH_DEV *flash_dev, uint16_t blocknum);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_erase_suspend(FLASH_DEV *flash_dev);
 ...
 * @return FLASH_STATUS
*/
extern FLASH_STATUS flash_extended_query(FLASH_DEV *flash_dev, struct _FLASH_EXTQUERY *extquery );
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_get_block_offset(FLASH_DEV *flash_dev, uint32_t blocknum, uint32_t *address );
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_get_query_address (FLASH_DEV *flash_dev, uint32_t offset, uint32_t *address );
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_lock_block (FLASH_DEV *flash_dev, uint16_t blocknum);

/**
 * This procedure is called to lock all blocks on the flash device.
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_lock_all_blocks (FLASH_DEV *flash_dev);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_lock_block_down (FLASH_DEV *flash_dev, uint16_t blocknum);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_lock_protection (FLASH_DEV *flash_dev, uint32_t ProtectionRegister);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_page_mode (FLASH_DEV *flash_dev, uint16_t enable);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_program_flash (FLASH_DEV *flash_dev, uint32_t address, uint32_t item);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_program_flash_buffered (FLASH_DEV *flash_dev, uint32_t address, uint32_t *buffer, uint32_t numbytes);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_program_protection (FLASH_DEV *flash_dev, uint32_t location, FLASH_FDATA value);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_program_suspend (FLASH_DEV *flash_dev);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_query (FLASH_DEV *flash_dev, struct _FLASH_QUERY_DATA *query);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_read_block_status (FLASH_DEV *flash_dev, uint16_t blocknum, FLASH_FDATA *blockstat);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_read_device_ID (FLASH_DEV *flash_dev, uint32_t *mcode, uint32_t *deviceid);
 ...
 */
extern FLASH_FDATA flash_readf (FLASH_DEV *flash_dev, uint32_t offset);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_read_flash (FLASH_DEV *flash_dev, uint32_t address, void *buffer, uint32_t numbytes);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_read_protection (FLASH_DEV *flash_dev, uint32_t location, uint32_t *value);
 ...
 */
extern uint32_t flash_read_status ( FLASH_DEV *flash_dev );
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_resume (FLASH_DEV *flash_dev);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_set_configuration (FLASH_DEV *flash_dev, uint16_t data);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_unlock_block (FLASH_DEV *flash_dev, uint16_t blocknum);
 ...
 * @return FLASH_STATUS
 */
extern FLASH_STATUS flash_unlock_all_blocks (FLASH_DEV *flash_dev);
 ...
 *                 occured.
 */
extern uint8_t flash_wait_until_ready (FLASH_DEV *flash_dev, uint32_t timeout);
