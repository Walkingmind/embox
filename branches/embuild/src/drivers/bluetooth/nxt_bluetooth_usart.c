...
#if 0
#define CONFIG_NXT_BT_CS_PIN     AT91C_PIO_PA31
#define CONFIG_NXT_BT_RST_PIN    AT91C_PIO_PA11
#define CONFIG_NXT_BT_CMD_PIN    AT91C_PIO_PA27
#endif
