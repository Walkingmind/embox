...
#define COMMAND_NAME     "store"
#define COMMAND_DESC_MSG "store memory area to flash"
#define HELP_MSG         "Usage: store [-h] -f <src_addr> -t <dst_addr> -n <numbytes>"

static const char *man_page =
	#include "store_help.inc"
;
