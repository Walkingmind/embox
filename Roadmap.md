# 2015/07/01 v0.4.0 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.4.0)] [[open issues](http://code.google.com/p/embox/issues/list?q=milestone=v0.4.0)] #
  * New build system
...
# 2013/09/15 v0.3.5 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.3.5)] #
...
# 2012/04/15 v0.3.1 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.3.1)] #
> ## Network ##
    * Added TCP protocol
...
# 2012/02/26 v0.3.0 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.3.0)] #
_Dedicated to Sikmir's children (Timur and Eugene)_
> ## Development ##
    * Add [Lua 5.1](http://www.lua.org/about.html) scripting support
...
# 2011/12/01 v0.2.3 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.2.3)] #
  * Added new dynamic allocation (bitmask for page allocation and boundary markers for malloc)
  * Started Lua porting
  * Started **pnet** stack research

# 2011/09/25 v0.2.2 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.2.2)] #
...
# 2010/05/01 v0.1.3 [[issues](http://code.google.com/p/embox/issues/list?can=1&q=milestone=v0.1.3)] #
