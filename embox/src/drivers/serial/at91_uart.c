...
void diag_init(void) {
	...
	REG_STORE(AT91C_US0_CR, AT91C_US_RXDIS | AT91C_US_TXDIS | \
							AT91C_US_RSTRX | AT91C_US_RSTTX); /*resetting & disabling RX, TX */
	//REG_STORE(AT91C_US0_MR, AT91C_US_CHRL_8_BITS | AT91C_US_CLKS_CLOCK ); //was 0x8c0, now there is Even Parity
	REG_STORE(AT91C_US0_BRGR, UART_CLOCK_DIVIDER); 
	REG_STORE(AT91C_US0_MR,  AT91C_US_PAR_NONE | AT91C_US_CHRL_8_BITS | AT91C_US_CLKS_CLOCK);
	REG_STORE(AT91C_PMC_PCER, 1 << AT91C_ID_US0); //enabling clocking USART
	REG_STORE(AT91C_US0_CR, AT91C_US_RXEN | AT91C_US_TXEN); /*enabling RX, TX */
}
