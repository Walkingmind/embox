...
static const struct vesa_mode_desc vesa_mode_text_descriptions[] = {
...
static const struct vesa_mode_desc vesa_mode_vga_descriptions[] = {
...
static const struct vesa_mode_desc vesa_mode_svga_descriptions[] = {
...
const struct vesa_mode_desc * vesa_mode_get_desc(enum vesa_video_mode mode) {
