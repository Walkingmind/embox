 ...
 */
extern void queue_add(struct list_head *list, queue *a_queue);
 ...
 */
extern struct list_head* queue_extr(queue *a_queue);
 ...
 */
extern bool queue_empty(queue *a_queue);
 ...
 */
extern void queue_init(queue *a_queue);
