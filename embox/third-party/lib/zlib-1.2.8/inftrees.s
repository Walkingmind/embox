...
.L73:
	...
	movl	$-1, 48(%esp)
	.loc 1 195 0
	movl	$dext.2431, 68(%esp)
	.loc 1 194 0
	movl	$dbase.2430, 64(%esp)
	jmp	.L19
.LVL169:
.L17:
	.loc 1 203 0
...
.LVL173:
	...
	movl	$256, 48(%esp)
	.loc 1 190 0
	movl	$lext.2429-514, 68(%esp)
	.loc 1 188 0
	movl	$lbase.2428-514, 64(%esp)
	.loc 1 211 0
	cmpl	$852, 52(%esp)
	jbe	.L19
	jmp	.L81
...
.Letext0:
	.file 2 "inftrees.h"
	.file 3 "/home/anton/workspace/embox-trunk/./src/include/../util/dlist_debug.h"
