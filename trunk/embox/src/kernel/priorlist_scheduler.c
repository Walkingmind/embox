...
#define priority_head          (&priority_pool[0]) /* - голова списка приоритетов - нулевай приоритет, за ним идёт максимальный*/
 ...
 * TODO: посмотреть и разобратся, возможно не дописано...
 */
