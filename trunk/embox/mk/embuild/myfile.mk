...
# <ModuleBodyDecl> symbol.
define $(gold_prefix)_Symbol_ModuleBodyDecl
endef

# <ModuleBodyDecls> symbol.
...
# <ModuleModifier> symbol.
define $(gold_prefix)_Symbol_ModuleModifier
endef

# <ModuleModifiers> symbol.
...
# <QualifiedNameWithWildcard> symbol.
...
# <SourceStatement> symbol.
define $(gold_prefix)_Symbol_SourceStatement
endef

# <SourceStatements> symbol.
...
# <Model> ::= <PackageDecl> <ImportDecls> <ModuleDecls> rule.
define $(gold_prefix)_Rule_Model
endef

# <PackageDecl> ::= package <QualifiedName> ';' rule.
...
# <ImportDecls> ::= <ImportDecl> <ImportDecls> rule.
...
# <ImportDecl> ::= import <QualifiedNameWithWildcard> ';' rule.
define $(gold_prefix)_Rule_ImportDecl_import_Semi
endef

# <ModuleDecls> ::= <ModuleDecl> <ModuleDecls> rule.
...
# <ModuleDecl> ::= <ModuleModifiers> module Identifier <SuperModules> '{' <ModuleBodyDecls> '}' rule.
define $(gold_prefix)_Rule_ModuleDecl_module_Identifier_LBrace_RBrace
endef

# <ModuleModifiers> ::= <ModuleModifier> <ModuleModifiers> rule.
define $(gold_prefix)_Rule_ModuleModifiers
endef

# <ModuleModifiers> ::=  rule.
define $(gold_prefix)_Rule_ModuleModifiers2
endef

# <ModuleModifier> ::= static rule.
define $(gold_prefix)_Rule_ModuleModifier_static
endef

# <ModuleModifier> ::= abstract rule.
define $(gold_prefix)_Rule_ModuleModifier_abstract
endef

# <SuperModules> ::= extends <SuperModulesList> rule.
