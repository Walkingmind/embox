...
SECTIONS {
	.app.data.$2 : { *(.data); }
	PROVIDE(__app_$2_data_vma =   ADDR(.app.data.$2));
	PROVIDE(__app_$2_data_len = SIZEOF(.app.data.$2));

	.app.bss.$2  : { *(.bss); }
	PROVIDE(__app_$2_bss_vma =   ADDR(.app.bss.$2));
	PROVIDE(__app_$2_bss_len = SIZEOF(.app.bss.$2));
}
endef
