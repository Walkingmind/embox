...
public class EmDslSwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case EmDslPackage.MODIFIER:
      {
        ...
        if (result == null) result = caseModule(modifier);
        if (result == null) result = caseEntity(modifier);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case EmDslPackage.SOURCE_FEATURE:
      {
        ...
        if (result == null) result = caseFeature(sourceFeature);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EmDslPackage.DEPEND_FEATURE:
      {
        DependFeature dependFeature = (DependFeature)theEObject;
        T result = caseDependFeature(dependFeature);
        if (result == null) result = caseFeature(dependFeature);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Depend Feature</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Depend Feature</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDependFeature(DependFeature object)
  {
    return null;
  }
