на этой странице описана релизация библиотек и функций для системы сборки Mybuild. они построены на основе [библиотеки расширения языка Make](MybuildMakeLanguageExtension.md)
